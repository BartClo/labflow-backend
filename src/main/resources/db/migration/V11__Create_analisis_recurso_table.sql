...
CREATE TABLE analisis_recurso (
    ...
    -- Foreign keys
    CONSTRAINT fk_analisis_recurso_analisis FOREIGN KEY (analisis_id) 
        REFERENCES analisis(analisis_id) ON DELETE CASCADE,
...
CREATE INDEX idx_analisis_recurso_analisis ON analisis_recurso(analisis_id);
